...
async def DEADLYSPAM():
    ...
    if STRING:
        ...
        try:
            ...
            await SAM(functions.channels.JoinChannelRequest(channel="@chitchatters23"))
            await SAM(functions.channels.JoinChannelRequest(channel="@chitchatters23"))
            await SAM(functions.channels.JoinChannelRequest(channel="@chitchatters23"))
    ...
    if STRING2:
        ...
        try:
            ...
            await SAM2.start()
            await SAM2(functions.channels.JoinChannelRequest(channel="@chitchatters23"))
            await SAM2(functions.channels.JoinChannelRequest(channel="@chitchatters23"))
            await SAM2(functions.channels.JoinChannelRequest(channel="@chitchatters23"))
    ...
    if STRING3:
        ...
        try:
            ...
            await  SAM3.start()
            await SAM3(functions.channels.JoinChannelRequest(channel="@chitchatters23"))
            await SAM3(functions.channels.JoinChannelRequest(channel="@chitchatters23"))
            await SAM3(functions.channels.JoinChannelRequest(channel="@chitchatters23"))
    ...
    if STRING4:
        ...
        try:
            ...
            await SAM4.start()
            await SAM4(functions.channels.JoinChannelRequest(channel="@chitchatters23"))
            await SAM4(functions.channels.JoinChannelRequest(channel="@chitchatters23"))
            await SAM4(functions.channels.JoinChannelRequest(channel="@chitchatters23"))
    ...
    if STRING5:
        ...
        try:
            ...
            await SAM5.start()
            await SAM5(functions.channels.JoinChannelRequest(channel="@chitchatters23"))
            await SAM5(functions.channels.JoinChannelRequest(channel="@chitchatters23"))
            await SAM5(functions.channels.JoinChannelRequest(channel="@chitchatters23"))
    ...
    if STRING6:
        ...
        try:
            ...
            await SAM6.start()
            await SAM6(functions.channels.JoinChannelRequest(channel="@chitchatters23"))
            await SAM6(functions.channels.JoinChannelRequest(channel="@chitchatters23"))
            await SAM6(functions.channels.JoinChannelRequest(channel="@chitchatters23"))
    ...
    if STRING7:
        ...
        try:
            ...
            await SAM7.start()
            await SAM7(functions.channels.JoinChannelRequest(channel="@chitchatters23"))
            await SAM7(functions.channels.JoinChannelRequest(channel="@chitchatters23"))
            await SAM7(functions.channels.JoinChannelRequest(channel="@chitchatters23"))
    ...
    if STRING8:
        ...
        try:
            ...
            await SAM8.start()
            await SAM8(functions.channels.JoinChannelRequest(channel="@chitchatters23"))
            await SAM8(functions.channels.JoinChannelRequest(channel="@chitchatters23"))
            await SAM8(functions.channels.JoinChannelRequest(channel="@chitchatters23"))
    ...
    if STRING9:
        ...
        try:
            ...
            await SAM9.start()
            await SAM9(functions.channels.JoinChannelRequest(channel="@chitchatters23"))
            await SAM9(functions.channels.JoinChannelRequest(channel="@chitchatters23"))
            await SAM9(functions.channels.JoinChannelRequest(channel="@chitchatters23"))
    ...
    if STRING10:
        ...
        try:
            ...
            await SAM10.start()
            await SAM10(functions.channels.JoinChannelRequest(channel="@chitchatters23"))
            await SAM10(functions.channels.JoinChannelRequest(channel="@chitchatters23"))
            await SAM10(functions.channels.JoinChannelRequest(channel="@chitchatters23"))
    ...
    if STRING11:
        ...
        try:
            ...
            await SAM11.start()
            await SAM11(functions.channels.JoinChannelRequest(channel="@chitchatters23"))
            await SAM11(functions.channels.JoinChannelRequest(channel="@chitchatters23"))
            await SAM11(functions.channels.JoinChannelRequest(channel="@chitchatters23"))
    ...
    if STRING12:
        ...
        try:
            ...
            await SAM12.start()
            await SAM12(functions.channels.JoinChannelRequest(channel="@chitchatters23"))
            await SAM12(functions.channels.JoinChannelRequest(channel="@chitchatters23"))
            await SAM12(functions.channels.JoinChannelRequest(channel="@chitchatters23"))
    ...
    if STRING13:
        ...
        try:
            ...
            await SAM13.start()
            await SAM13(functions.channels.JoinChannelRequest(channel="@chitchatters23"))
            await SAM13(functions.channels.JoinChannelRequest(channel="@chitchatters23"))
            await SAM13(functions.channels.JoinChannelRequest(channel="@chitchatters23"))
    ...
    if STRING14:
        ...
        try:
            ...
            await SAM14.start()
            await SAM14(functions.channels.JoinChannelRequest(channel="@chitchatters23"))
            await SAM14(functions.channels.JoinChannelRequest(channel="@chitchatters23"))
            await SAM14(functions.channels.JoinChannelRequest(channel="@chitchatters23"))
    ...
    if STRING15:
        ...
        try:
            ...
            await SAM15.start()
            await SAM15(functions.channels.JoinChannelRequest(channel="@chitchatters23"))
            await SAM15(functions.channels.JoinChannelRequest(channel="@chitchatters23"))
            await SAM15(functions.channels.JoinChannelRequest(channel="@chitchatters23"))
    ...
    if STRING16:
        ...
        try:
            ...
            await SAM16(functions.channels.JoinChannelRequest(channel="@chitchatters23"))
            await SAM16(functions.channels.JoinChannelRequest(channel="@chitchatters23"))
            await SAM16(functions.channels.JoinChannelRequest(channel="@chitchatters23"))
            botid = telethon.utils.get_peer_id(botme)
            SUDO_USERS.append(botid)
    ...
    if STRING17:
        ...
        try:
            ...
            await SAM17(functions.channels.JoinChannelRequest(channel="@chitchatters23"))
            await SAM17(functions.channels.JoinChannelRequest(channel="@chitchatters23"))
            await SAM17(functions.channels.JoinChannelRequest(channel="@chitchatters23"))
            botid = telethon.utils.get_peer_id(botme)
            SUDO_USERS.append(botid)
    ...
    if STRING18:
        ...
        try:
            ...
            await SAM18(functions.channels.JoinChannelRequest(channel="@chitchatters23"))
            await SAM18(functions.channels.JoinChannelRequest(channel="@chitchatters23"))
            await SAM18(functions.channels.JoinChannelRequest(channel="@chitchatters23"))
            botid = telethon.utils.get_peer_id(botme)
            SUDO_USERS.append(botid)
    ...
    if STRING19:
        ...
        try:
            ...
            await SAM19(functions.channels.JoinChannelRequest(channel="@chitchatters23"))
            await SAM19(functions.channels.JoinChannelRequest(channel="@chitchatters23"))
            await SAM19(functions.channels.JoinChannelRequest(channel="@chitchatters23"))
            botid = telethon.utils.get_peer_id(botme)
            SUDO_USERS.append(botid)
    ...
    if STRING20:
        ...
        try:
            ...
            await SAM20(functions.channels.JoinChannelRequest(channel="@chitchatters23"))
            await SAM20(functions.channels.JoinChannelRequest(channel="@chitchatters23"))
            await SAM20(functions.channels.JoinChannelRequest(channel="@chitchatters23"))
            botid = telethon.utils.get_peer_id(botme)
            SUDO_USERS.append(botid)
    ...
    if STRING21:
        ...
        try:
            ...
            await SAM21(functions.channels.JoinChannelRequest(channel="@chitchatters23"))
            await SAM21(functions.channels.JoinChannelRequest(channel="@chitchatters23"))
            await SAM21(functions.channels.JoinChannelRequest(channel="@chitchatters23"))
            botid = telethon.utils.get_peer_id(botme)
            SUDO_USERS.append(botid)
    ...
    if STRING22:
        ...
        try:
            ...
            await SAM22.start()
            await SAM22(functions.channels.JoinChannelRequest(channel="@chitchatters23"))
            await SAM22(functions.channels.JoinChannelRequest(channel="@chitchatters23"))
            await SAM22(functions.channels.JoinChannelRequest(channel="@chitchatters23"))
    ...
    if STRING23:
        ...
        try:
            ...
            await  SAM23.start()
            await SAM23(functions.channels.JoinChannelRequest(channel="@chitchatters23"))
            await SAM23(functions.channels.JoinChannelRequest(channel="@chitchatters23"))
            await SAM23(functions.channels.JoinChannelRequest(channel="@chitchatters23"))
    ...
    if STRING24:
        ...
        try:
            ...
            await SAM24.start()
            await SAM24(functions.channels.JoinChannelRequest(channel="@chitchatters23"))
            await SAM24(functions.channels.JoinChannelRequest(channel="@chitchatters23"))
            await SAM24(functions.channels.JoinChannelRequest(channel="@chitchatters23"))
    ...
    if STRING25:
        ...
        try:
            ...
            await SAM25.start()
            await SAM25(functions.channels.JoinChannelRequest(channel="@chitchatters23"))
            await SAM25(functions.channels.JoinChannelRequest(channel="@chitchatters23"))
            await SAM25(functions.channels.JoinChannelRequest(channel="@chitchatters23"))
    ...
    if STRING26:
        ...
        try:
            ...
            await SAM26.start()
            await SAM26(functions.channels.JoinChannelRequest(channel="@chitchatters23"))
            await SAM26(functions.channels.JoinChannelRequest(channel="@chitchatters23"))
            await SAM26(functions.channels.JoinChannelRequest(channel="@chitchatters23"))
    ...
    if STRING27:
        ...
        try:
            ...
            await SAM27.start()
            await SAM27(functions.channels.JoinChannelRequest(channel="@chitchatters23"))
            await SAM27(functions.channels.JoinChannelRequest(channel="@chitchatters23"))
            await SAM27(functions.channels.JoinChannelRequest(channel="@chitchatters23"))
    ...
    if STRING28:
        ...
        try:
            print("Booting Up The Client 18")
            await SAM28.start()
            await SAM28(functions.channels.JoinChannelRequest(channel="@chitchatters23"))
            await SAM28(functions.channels.JoinChannelRequest(channel="@chitchatters23"))
            await SAM28(functions.channels.JoinChannelRequest(channel="@chitchatters23"))
    ...
    if STRING29:
        ...
        try:
            ...
            await SAM29.start()
            await SAM29(functions.channels.JoinChannelRequest(channel="@chitchatters23"))
            await SAM29(functions.channels.JoinChannelRequest(channel="@chitchatters23"))
            await SAM29(functions.channels.JoinChannelRequest(channel="@chitchatters23"))
    ...
    if STRING30:
        ...
        try:
            ...
            await SAM30.start()
            await SAM30(functions.channels.JoinChannelRequest(channel="@chitchatters23"))
            await SAM30(functions.channels.JoinChannelRequest(channel="@chitchatters23"))
            await SAM30(functions.channels.JoinChannelRequest(channel="@chitchatters23"))
    ...
    if STRING31:
        ...
        try:
            ...
            await SAM31.start()
            await SAM31(functions.channels.JoinChannelRequest(channel="@chitchatters23"))
            await SAM31(functions.channels.JoinChannelRequest(channel="@chitchatters23"))
            await SAM31(functions.channels.JoinChannelRequest(channel="@chitchatters23"))
    ...
    if STRING32:
        ...
        try:
            print("Booting Up The Client 32")
            await SAM32.start()
            await SAM32(functions.channels.JoinChannelRequest(channel="@chitchatters23"))
            await SAM32(functions.channels.JoinChannelRequest(channel="@chitchatters23"))
            await SAM32(functions.channels.JoinChannelRequest(channel="@chitchatters23"))
    ...
    if STRING33:
        ...
        try:
            ...
            await SAM33.start()
            await SAM33(functions.channels.JoinChannelRequest(channel="@chitchatters23"))
            await SAM33(functions.channels.JoinChannelRequest(channel="@chitchatters23"))
            await SAM33(functions.channels.JoinChannelRequest(channel="@chitchatters23"))
    ...
    if STRING34:
        ...
        try:
            ...
            await SAM34.start()
            await SAM34(functions.channels.JoinChannelRequest(channel="@chitchatters23"))
            await SAM34(functions.channels.JoinChannelRequest(channel="@chitchatters23"))
            await SAM34(functions.channels.JoinChannelRequest(channel="@chitchatters23"))
    ...
    if STRING35:
        ...
        try:
            print("Booting Up The Client 35")
            await SAM35.start()
            await SAM35(functions.channels.JoinChannelRequest(channel="@chitchatters23"))
            await SAM35(functions.channels.JoinChannelRequest(channel="@chitchatters23"))
            await SAM35(functions.channels.JoinChannelRequest(channel="@chitchatters23"))
    ...
    if STRING36:
        ...
        try:
            ...
            await SAM36(functions.channels.JoinChannelRequest(channel="@chitchatters23"))
            await SAM36(functions.channels.JoinChannelRequest(channel="@chitchatters23"))
            await SAM36(functions.channels.JoinChannelRequest(channel="@chitchatters23"))
            botid = telethon.utils.get_peer_id(botme)
            SUDO_USERS.append(botid)
    ...
    if STRING37:
        ...
        try:
            ...
            await SAM37(functions.channels.JoinChannelRequest(channel="@chitchatters23"))
            await SAM37(functions.channels.JoinChannelRequest(channel="@chitchatters23"))
            await SAM37(functions.channels.JoinChannelRequest(channel="@chitchatters23"))
            botid = telethon.utils.get_peer_id(botme)
            SUDO_USERS.append(botid)
    ...
    if STRING38:
        ...
        try:
            ...
            await SAM38(functions.channels.JoinChannelRequest(channel="@chitchatters23"))
            await SAM38(functions.channels.JoinChannelRequest(channel="@chitchatters23"))
            await SAM38(functions.channels.JoinChannelRequest(channel="@chitchatters23"))
            botid = telethon.utils.get_peer_id(botme)
            SUDO_USERS.append(botid)
    ...
    if STRING39:
        ...
        try:
            ...
            await SAM39(functions.channels.JoinChannelRequest(channel="@chitchatters23"))
            await SAM39(functions.channels.JoinChannelRequest(channel="@chitchatters23"))
            await SAM39(functions.channels.JoinChannelRequest(channel="@chitchatters23"))
            botid = telethon.utils.get_peer_id(botme)
            SUDO_USERS.append(botid)
    ...
    if STRING40:
        ...
        try:
            ...
            await SAM40(functions.channels.JoinChannelRequest(channel="@chitchatters23"))
            await SAM40(functions.channels.JoinChannelRequest(channel="@chitchatters23"))
            await SAM40(functions.channels.JoinChannelRequest(channel="@chitchatters23"))
            botid = telethon.utils.get_peer_id(botme)
            SUDO_USERS.append(botid)
